...
RSpec.configure do |config|
  config.before(:each) do
    ...
    @claims_auth_user2 = ClaimsAuthService.new(ClaimsAuthUrls::SERVICES_URL, ConfigFile::ConfigFile_JSON)
    @claims_auth_user2.set_auth(UserInfo::DomainUser, UserInfo::UserPassword)
    @claims_auth_user2.set_log_filepath('ClaimsAutLog.txt')
  end
...
#   DataClient.configure do |dataClient|
#     dataClient.api_server  = "http://mtpctscid593.consilio.com/odata"
#   end
